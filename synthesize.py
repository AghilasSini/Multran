...
def main():
	...
	parser.add_argument('--mel_reference', default=None,help='Defines the reference mel-spectogram to use for Tacotron-2 with refeference')
...
# python3 synthesize.py --model="Tacotron" --name="Tacotron-2" --mode="eval" --text_list="sentences_phone.txt" --GTA=False --mel_reference="/home/aperquin/Programmes/Tacotron-2-from-reference/training_data/mels/mel-p307_051.npy"
